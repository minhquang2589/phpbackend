   ...
   <table class="min-w-full divide-y-2 divide-gray-200 bg-white text-sm">
      <thead class="ltr:text-left rtl:text-right">
         <tr>
            ...
            <th class="whitespace-nowrap px-4 py-2 font-medium text-gray-900">is_admin</th>
      ...
      @foreach($users as $user)
         <tr>
            ...
            <td class="whitespace-nowrap px-4 py-2 font-medium text-gray-700">{{$user->is_admin}}</td>
