...
<div class="z-50" x-data="setup()" x-init="$refs.loading.classList.add('hidden');">
  ...
  <!--  -->
    <div class="flex h-screen antialiased text-gray-900  dark:bg-dark dark:text-light">
        ...
        <div
          x-ref="loading"
          class="fixed inset-0 z-10 flex items-center justify-center text-2xl font-semibold text-white bg-gray-600"
          >
          Loading.....
        </div>
        <!-- Sidebar -->
          ...
          <div class="z-10 flex flex-col flex-1">
            ...
            <nav class="flex flex-col flex-1 w-64 p-4 mt-4">
              <div  class="flex items-center space-x-2">
                ...
                <!--  -->
                <div class="flex items-center mt-3 ">
                    <span class="mr-30 " ><a href="/productmanagement">All Table</a></span>
                </div>
                <!-- lineeeeee -->
                <span class="flex items-center">
                      <span class="h-px flex-1 bg-slate-200"></span>
                ...
                <!--  -->
                <div class="flex items-center mt-3 ">
                    <span class="mr-30 " ><a href="/alltable">Generate API Key</a></span>
                </div>
                <!-- lineeeeee -->
                <span class="flex items-center">
                      <span class="h-px flex-1 bg-slate-200"></span>
