...
<!--  -->
<!-- <div>
<div class=" fixed flex h-screen w-16 flex-col justify-between border-e bg-white">
    <div class="border-t border-gray-100">
      ...
      <div class="sticky top-2/4 translate-y-3/4	 inset-x-0 bottom-0 border-t border-gray-100 bg-white p-2">
        <form action="#">
        <button
            type="submit"
