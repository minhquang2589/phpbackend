...
<!-- form -->
                <form method="POST" action="{{ route('admin.login') }}">
                    ...
                    <div>
                        ...
                        <input class="w-full italic text-sm py-2 border-b border-gray-300 focus:outline-none focus:border-gray-800" type="email" id="email" name="email" for="email" placeholder="mike@gmail.com">
                        @error('email')
                    ...
                    <div class="mt-8">
                        ...
                        <input class="w-full italic text-sm py-2 border-b border-gray-300 focus:outline-none focus:border-gray-800" type="password" id="password" name="password" for="password" placeholder="Enter your password">
                        @error('password')
                        <div class="mt-0 text-red-700 rounded-xl relative" role="alert">
                            <span class="block sm:inline text-xs">{{ $message }}</span>
                        </div>
...
<!--  -->
                    <div class="mt-10">
                        <button type="submit" class="bg-gray-600 text-gray-100 p-4 w-full rounded-full tracking-wide font-semibold font-display focus:outline-none focus:shadow-outline hover:bg-gray-800 shadow-lg">
                            Log In
                        </button>
                    </div>
                </form>
