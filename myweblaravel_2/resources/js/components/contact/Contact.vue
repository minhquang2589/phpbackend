<template>
    ...
    <div class="flex justify-center">
        <div class="mt-14 grid grid-cols-1 gap-2 lg:grid-cols-3 lg:gap-5">
            <div class="h-h-fit">
                <h1>
                    <strong class="flex justify-center italic lg:col-span-1"
                        >CONTACT
                    </strong>
                </h1>
            </div>
            <div class="h-96 w-full lg:col-span-1">
                ...
                <p class="text-xs mt-20 italic">
                    If you have any questions, please contact via this email:
                </p>
            ...
            <div class="w-full h-full">
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d5519.541481512484!2d105.77900925393396!3d21.028098869540546!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1svi!2s!4v1713101578257!5m2!1svi!2s"
                    style="border: 0"
                    allowfullscreen=""
                    loading="lazy"
