...
Route::get('/product-view', [DashboardController::class, 'getProductView'])->name('get.roductview.product');
...
Route::middleware(['checkRole'])->group(function () {
    ...
    Route::post('/section', [SectionController::class, 'section_02Update'])->name('section_02.update');
    ...
    Route::post('/discount/edit', [DiscountController::class, 'discountEdit'])->name('discount.edit');
