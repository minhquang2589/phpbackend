<div class="my-5 mb-3 mt-10 mx-3 flex justify-center	">
  <div>
    <div class="font-medium text-black">Related products</div>
  </div>
</div>
<span class="flex items-center">
  <span class="h-px flex-1 bg-gray-300"></span>
</span>
<div id="productKankei" class="grid grid-cols-2 mx-6 lg:grid-cols-5 md:grid-cols-4 lg:gap-5 lg:mt-8 mt-4 mb-8 "></div>
  ...
  function loadMoreProducts() {
    ...
    $.ajax({
      ...
      success: function(response) {
        if (response.dataMoreProducts.productsMore.length > 0) {
          ...
          $('#loadMoreButton').text('End').prop('disabled', true).addClass('sold-out-ticket');
