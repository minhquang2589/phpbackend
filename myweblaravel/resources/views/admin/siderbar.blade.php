      ...
      <ul class=" space-y-1">
         ...
         <li>
            <details class="group [&_summary::-webkit-details-marker]:hidden">
               ...
               <ul class="mt-2 space-y-1 px-4">
                  <li>
                     <a href="{{Route('blog.upload')}}" class="block rounded-lg px-4 py-2 text-sm font-medium text-gray-800 hover:bg-gray-300 hover:text-black">
                        Upload
                     </a>
                  </li>
                  <li>
                     <a href="{{Route('blog.update')}}" class="block rounded-lg px-4 py-2 text-sm font-medium  text-gray-800 hover:bg-gray-300 hover:text-black">
                        Update
                     </a>
                  </li>
               </ul>
