...
echo'Viết PHP script để tạo một form đơn giản để nhận và hiển thị tên đăng nhập.'.'<br>';
 ...
 if($_SERVER['REQUEST_METHOD'] == 'POST'){
   ...
   echo'Lấy địa chỉ Client IP trong PHP.'.'<br>';
   $clientIP = $_SERVER['REMOTE_ADDR'];
   echo "Địa chỉ IP của client là" . $clientIP;
   echo'<br>';
   echo'<br>';
   echo'Lấy thông tin liên quan đến trình duyệt bạn đang sử dụng (User Agent) trong PHP.'.'<br>';
   $TTTrinhduyet = $_SERVER ['HTTP_USER_AGENT'];
   echo $TTTrinhduyet;
   echo'<br>';
   echo'<br>';
   echo'Viết PHP script để lấy tên file hiện tại.'.'<br>';
   $nameFile = $_SERVER['PHP_SELF'];
   echo 'Tên File hiện tại là :'. $nameFile;
   echo'<br>';
   echo'<br>';
   echo'Lấy URL trong PHP.'.'<br>';
