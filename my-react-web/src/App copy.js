        ...
        {Array.isArray(products) && products.map(product => (
            <div key={product.id} className="h-120 rounded-lg">
                <div className="group rounded-xl relative block overflow-hidden">
                    ...
                    <div>
                    <img src={`/images/${product.image}`} alt={product.image} className="primage min-h-full rounded-t-2xl w-full object-cover transition duration-500 group-hover:scale-105 sm:h-72" />
                    </div>
